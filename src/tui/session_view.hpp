...
// This intentionally favors deterministic full redraws over incremental diffing.
// The old diff path produced non-contiguous overwrites when viewport size changed.
#pragma once
