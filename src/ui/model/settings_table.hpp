...
inline constexpr SettingsRow kSettingsRows[] = {
    ...
    {SettingsRowKind::Item, SettingsOpt::Field, nullptr, "FIELD"},
    {SettingsRowKind::Item, SettingsOpt::Shader, nullptr, "SHADER"},

    {SettingsRowKind::Head, SettingsOpt::Count, "CHAT", nullptr},
    {SettingsRowKind::Item, SettingsOpt::Thoughts, nullptr, "THOUGHTS"},
    {SettingsRowKind::Item, SettingsOpt::Truncate, nullptr, "TRUNCATE"},
    {SettingsRowKind::Item, SettingsOpt::InputFmt, nullptr, "INPUT FMT"},
    {SettingsRowKind::Item, SettingsOpt::OutputFmt, nullptr, "OUTPUT FMT"},
    ...
    {SettingsRowKind::Item, SettingsOpt::PillHide, nullptr, "PILL HIDE"},
