...
inline bool isTTY(FILE* fp = stdout) {
    ...
    if (noColor || (term && std::string_view(term) == "dumb"))
        return false;
...
inline std::string cursorCol(int col) {
...
struct ColorGuard {
    ...
    static ColorGuard end() {
        return ColorGuard(reset);
    }
};
...
inline std::string redText(const std::string& t) {
    return wrap(red, t);
}
inline std::string greenText(const std::string& t) {
    return wrap(green, t);
}
inline std::string yellowText(const std::string& t) {
    return wrap(yellow, t);
}
inline std::string blueText(const std::string& t) {
    return wrap(blue, t);
}
inline std::string cyanText(const std::string& t) {
    return wrap(cyan, t);
}
inline std::string magentaText(const std::string& t) {
    return wrap(magenta, t);
}
inline std::string dimText(const std::string& t) {
    return wrap(dim, t);
}
inline std::string boldText(const std::string& t) {
    return wrap(bold, t);
}
inline std::string reverseText(const std::string& t) {
    return wrap(reverse, t);
}
...
inline int nextSpinnerFrame(int current) {
    return (current + 1) % spinnerFrameCount;
}
