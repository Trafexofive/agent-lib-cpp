 ...
 *
 * Build: gcc -o c_example c_example.c -I../include -L.. -lagent-mk2 -lcurl -lyaml-cpp -ljsoncpp
 * -lpthread Run:   LD_LIBRARY_PATH=.. ./c_example
 */
...
int main(int argc, char** argv) {
    ...
    printf("Response: ");
    char* result =
        cortex_agent_prompt_stream(agent, prompt, on_token, NULL, "demo_session", &error);
    printf("\n\n");
    ...
    cortex_err_t err =
        cortex_agent_dispatch_tool(agent, "list", "{\"path\":\".\"}", &tool_result, &error);
